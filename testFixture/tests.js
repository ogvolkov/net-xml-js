	...
	test("Deserializing SampleIntDate", function() {
		var xml = "<SampleIntDate xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><Id>42</Id><Date>2013-03-10T19:13:46.0221769+02:00</Date></SampleIntDate>";

		var result = netXmlSerializer.deserializeSampleIntDate(xml);

						deepEqual(result.Id, 42);
								deepEqual(result.Date, new Date(1362935626022));
